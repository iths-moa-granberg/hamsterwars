    ...
    return (
      <div className={styles.root}>
        ...
        <div className={styles.links}>
          ...
          <Link to="/upload/" className="secondary-btn" onClick={handleReload}>
            Upload another hamster
          </Link>
        </div>
      </div>
    );
  ...
  return (
    <div className={styles.root}>
      ...
      <form encType="multipart/form-data" className={styles['form-group']}>
        ...
        <button type="submit" disabled={!formIsValid} className="primary-btn" onClick={(e) => handleAddHamster(e)}>
          Add hamster
        </button>
      </form>
    </div>
